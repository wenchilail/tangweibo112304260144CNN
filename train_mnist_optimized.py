...
def train(model, train_loader, val_loader, criterion, optimizer, scheduler, device, epochs=30):
    best_acc = 0.0
...
def main():
    ...
    train(model, train_loader, val_loader, criterion, optimizer, scheduler, device, epochs=30)
    ...
    submission.to_csv('digit-recognizer/submission_optimized.csv', index=False)
    print('Optimized submission file created: digit-recognizer/submission_optimized.csv')
